...
$cfg['Servers'][$i]['user'] = 'logzxmyktlbb9n4u'; //change to yours
$cfg['Servers'][$i]['password'] = 'qtnm2iy50ftu1ttx'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'ik1eybdutgxsm0lo.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
